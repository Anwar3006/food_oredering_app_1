...
import { customizationTable } from "./customization.schema.js";

export const menuCustomizationTable = pgTable("menu_customization", {
  id: uuid().primaryKey().defaultRandom(),
  customization_id: uuid("customization_id").references(
    () => customizationTable.id,
    { onDelete: "cascade" }
  ),
  menu_item_id: uuid("menu_item_id").references(() => menuItemTable.id, {
    onDelete: "cascade",
  }),
